package org.com.message.common.config;
...
public class SwaggerConfig {
    ...
    private static final String API_TITLE = "MQTT-Kafka API";
    private static final String API_VERSION = "0.0.1";
    private static final String API_DESCRIPTION = "MQTT-Kafka API 명세서";
